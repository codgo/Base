...
use TypiCMS\Modules\Downloads\Http\Controllers\AdminController;
use TypiCMS\Modules\Downloads\Http\Controllers\ApiController;
            ...
            foreach (locales() as $lang) {
                if ($page->isPublished($lang) && $uri = $page->uri($lang)) {
                    Route::middleware($middleware)->prefix($uri)->name($lang.'::')->group(function (Router $router) {
                        ...
                        $router->get('{slug}', [PublicController::class, 'show'])->name('download');
                    });
                }
            }
        }
